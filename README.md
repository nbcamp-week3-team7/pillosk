...
| **UI/UX 피그마** |
|:----------------:|
| ![피그마 와이어프레임](https://github.com/user-attachments/assets/f9363f56-0267-422e-876d-11c5480507b0) |
| 이 와이어프레임은 Pillosk 앱의 UI/UX 디자인을 구상한 피그마 프로젝트입니다. 각 화면은 카테고리 선택, 상품 목록, 장바구니, 결제 화면으로 구성되어 있으며 사용자 경험을 최적화하기 위한 레이아웃과 요소 배치를 보여줍니다. |
